...
/// <summary>The credits screen (the dragon "staff" art). Escape or the button returns to the start menu.</summary>
internal class CreditsState : IGameObject
{
    ...
    public CreditsState(Font font, TextureManager textureManager, Input input, StateSystem system)
    {
        _textureManager = textureManager;
        _system = system;
        _input = input;
        _font = font;
        _background.Texture = _textureManager.Get("staff_F0_C0");
        InitializeMenu();
    }
